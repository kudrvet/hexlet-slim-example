...
ршрут /companies, по которому отдаётся список компаний в виде json. Компании отдаются не все сразу, а только соответствующие текущей запрошенной странице. По умолчанию выдаётся 5 результатов на запрос.
...
$app->get('/companies', function ($request, $response) use ($companies) {
	...
	$data = array_slice($companies, ($page-1)*$per, $per);
